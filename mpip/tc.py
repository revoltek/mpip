...
############################################################
def Int(value=0, doc=None, group=None, colname=None, units=None, activator=None):
    """Create tc-value of type int"""
    return TC(value, tcCType(int), doc, group, colname, units)

def Float(value=0., doc=None, group=None, colname=None, units=None, activator=None):
    """Create tc-value of type float"""
    return TC(value, tcCType(float), doc, group, colname, units)

def Bool(value=False, doc=None, group=None, activator=None):
    """Create tc-value of type bool"""
    return TC(value, tcCType(bool), doc, group)

def String(value='', doc=None, group=None, colname=None, units=None, activator=None):
...
def Tuple(*values, **kws):
    ...
    kws: keyword arguments. Currently only 'doc', 'group' and 'activator'
    are recognized
    ...
    activator = kws.pop('activator', None)
    if len(values) == 0:
...
def Option(value, type=None, doc=None, group=None, activator=None):
...
def NArray(value=None, or_none=True, doc=None, group=None, colname=None,
           units=None, activator=None):
    """Creates tc-value which holds Numpy arrays
    It also interpret a string as "1,3..6"=[1,3,4,5,6] (convert
    all numbers to int)
...
def Instance(value, type=None, or_none=True, doc=None, group=None,
             colname=None, units=None, activator=None):
...
def List(value, type=None, doc=None, group=None, colname=None, units=None, activator=None):
